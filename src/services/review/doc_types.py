...
DOC_TYPE_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    "dywcrcns": {
        "platform": "reward",
        "zh_label": "第一完成人承诺书",
        "en_label": "First Contributor Commitment",
        "aliases": ["5.10", "第一完成人承诺书", "dywcrcns"],
        "legacy_doc_kind": "dywcrcns",
        "rules": [
            "signature",
        ...
        "llm_extract_fields": [],
        "auto_llm_analysis": True,
        "description": "奖励申报中的第一完成人承诺书。",
        "remarks": "奖励平台材料",
    },
    "dywcdwcns": {
        "platform": "reward",
        "zh_label": "第一完成单位承诺书",
        "en_label": "First Completion Unit Commitment",
        "aliases": ["5.15", "第一完成单位承诺书", "dywcdwcns"],
        "legacy_doc_kind": "dywcdwcns",
        "rules": [
            "stamp",
        ...
        "llm_extract_fields": [],
        "auto_llm_analysis": True,
        "description": "奖励申报中的第一完成单位承诺书。",
        "remarks": "奖励平台材料",
    },
    "qysm": {
        "platform": "reward",
        "zh_label": "企业声明",
        "en_label": "Enterprise Statement",
        "aliases": ["5.16", "企业声明", "qysm"],
        "legacy_doc_kind": "qysm",
        "rules": [
            "signature",
            "stamp",
