...
PROJECT_CONFIG: Dict[str, Dict[str, Any]] = {
    "regional_innovation": {
        ...
        "project_rules": [
            ...
            "leader_achievement_attachment_check",
        ...
        "policy_review_points": [
            ...
            {"code": "cooperation_region_check", "requirement": "合作单位非新疆维吾尔自治区巴音郭楞蒙古自治州、新疆生产建设兵团第二师铁门关市或西藏自治区阿里地区注册的企事业单位。", "automation": "auto"},
