...
# 现在可以正常导入src模块
from src.services.plagiarism.formatted_report_builder import FormattedPlagiarismReportBuilder


def main():
    # 路径配置
    debug_json = Path("debug_plagiarism/plagiarism_debug.json")
    output_html = Path("debug_plagiarism/plagiarism_report.html")
    ...
    # 生成报告
    builder = FormattedPlagiarismReportBuilder()
    ...
    print(f"[Report] Formatted HTML report generated: {output_html.absolute()}")
